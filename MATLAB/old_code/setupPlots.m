function [pointer_patch, pile_img, avalanche_ct_plot,...
    avalanche_desc_text, shannonPlot] = setupPlots(pile_width, draw_speed, sand_sum)
...
avalanche_desc_text = text(1, 1, 1,...
    {[num2str(sand_sum) ' initial sand grains'];
    '0 dropped sand grains'; 
